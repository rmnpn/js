...
console.log(deckOfCards.find(value => value.value==='ace' && value.cardSuit===`diamond`));
...
//
console.log(deckOfCards.filter(value => value.cardSuit === `clubs` && [`9`,'10','jack','queene','king','ace'].includes(value.value)));
//признаюсь, спиздив в тебе)
